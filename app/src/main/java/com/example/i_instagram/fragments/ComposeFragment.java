...
import com.example.i_instagram.LoginActivity;
import com.example.i_instagram.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        capture = view.findViewById(R.id.btnCaptureImage);
        image = view.findViewById(R.id.ivPostImage);
        submit = view.findViewById(R.id.btnPost);
        ...
        Log.i(TAG, "setOnClickListener: launchCamera()");

        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.i(TAG, "setOnClickListener: post");
